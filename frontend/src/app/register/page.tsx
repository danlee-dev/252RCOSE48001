  ...
  return (
    <div className="min-h-dvh flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
        {/* Liquid blobs */}
        <div className="liquid-blob liquid-blob-1" style={{ top: '5%', left: '15%' }} />
        <div className="liquid-blob liquid-blob-2" style={{ top: '50%', left: '-5%' }} />
        <div className="liquid-blob liquid-blob-3" style={{ bottom: '15%', right: '5%' }} />
      ...
      <div className="flex-1 lg:flex-none lg:w-[460px] flex items-center justify-center p-6 sm:p-8 bg-white relative overflow-hidden">
        ...
        <div className="w-full max-w-[360px] relative z-10">
          {/* Mobile Logo */}
          <div className="text-center mb-8 lg:hidden animate-slide-in-bottom">
          ...
          {/* Desktop Header */}
          <div className="hidden lg:block mb-6 animate-slide-in-bottom">
          ...
          <div className="liquid-glass-card p-7 animate-slide-in-bottom stagger-2">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 tracking-tight">
                  이름
                </label>
                <input
                  id="name"
              ...
              <div className="space-y-2">
                <label htmlFor="passwordConfirm" className="block text-sm font-medium text-gray-700 tracking-tight">
                  비밀번호 확인
                </label>
                <div className="relative">
                  <input
              ...
              <button
                ...
                className="w-full py-4 liquid-button flex items-center justify-center gap-2 tracking-tight text-[15px] group mt-3"
              >
                {loading ? (
                  <>
          ...
          {/* Footer Link */}
          <div className="text-center mt-6 animate-slide-in-bottom stagger-3">

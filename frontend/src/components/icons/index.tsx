...
export function IconChecklist({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Logo({ className, size = 40, color = "#256BDD" }: LogoProps) {
  // Original viewBox: 211x237, aspect ratio ~0.89
  const height = size;
  const width = Math.round(size * (211 / 237));
  ...
  return (
    ...
    >
      <path
        d="M43.7853 5.81418C44.5798 2.40898 47.6156 0 51.1123 0H140.994C145.84 0 149.422 4.51423 148.321 9.23344L125.499 107.043C124.704 110.448 121.668 112.857 118.172 112.857H28.2901C23.4441 112.857 19.8619 108.343 20.9631 103.624L43.7853 5.81418Z"
        fill={color}
      />
      <path
        d="M85.1681 129.957C85.9626 126.552 88.9984 124.143 92.4951 124.143H182.377C187.223 124.143 190.805 128.657 189.704 133.376L166.881 231.186C166.087 234.591 163.051 237 159.554 237H69.6729C64.8269 237 61.2447 232.485 62.3459 227.766L85.1681 129.957Z"
        fill={color}
      />
      <path
        d="M146.051 54.6245C146.881 51.2653 149.895 48.9053 153.355 48.9053H201.055C205.941 48.9053 209.531 53.4901 208.359 58.2336L196.277 107.138C195.447 110.498 192.433 112.858 188.973 112.858H141.273C136.387 112.858 132.797 108.273 133.969 103.529L146.051 54.6245Z"
        fill={color}
      />
      <path
        d="M14.387 129.862C15.2169 126.503 18.231 124.143 21.6912 124.143H69.3911C74.2773 124.143 77.8673 128.727 76.6953 133.471L64.613 182.376C63.7831 185.735 60.769 188.095 57.3088 188.095H9.60886C4.72269 188.095 1.13272 183.51 2.30466 178.767L14.387 129.862Z"
        fill={color}
      />
    </svg>
  );
